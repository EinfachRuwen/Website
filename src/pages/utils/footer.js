        ...
        return (
            <footer className="sticky bottom-0 left-0 w-screen text-center py-3 bg-gray-900">
                ...
                <div className="flex items-center md:px-10 px-3">
                    ...
                    <img src="./image/icon_twitter.png" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_twitter" onclick="window.open('https://byzer0.ml/twitter')" /> 
                    <img src="./image/icon_patreon.png" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_patreon" onclick="window.open('https://byzer0.ml/patreon')" /> 
                    <img src="./image/icon_youtube.png" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_youtube" onclick="window.open('https://byzer0.ml/yt')" /> 
                    <img src="./image/icon_reddit.png" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_reddit" onclick="window.open('https://byzer0.ml/reddit')" /> 
                    <img src="./image/icon_donate.png" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_donate" onclick="window.open('https://byzer0.ml/donate')" />
                </div>
