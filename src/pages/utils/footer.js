        ...
        return (
            <footer className="w-screen text-center py-3 bg-gray-900">
                ...
                <div className="flex items-center md:px-10 px-3">
                    <img alt="" src="./image/icon_discord.png" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_twitter" onClick={() => window.open('discord://-/users/390965278470569985')} />
