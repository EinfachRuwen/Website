        ...
        return (
            <footer className="w-screen text-center py-3 bg-gray-900">
                ...
                <div className="flex items-center md:px-10 px-3">
                    ...
                    <img alt="" src="./image/pixelfed.svg" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_pixelfed" onClick={() => window.open('https://byzer0.ml/pixelfed')} /> 
                    <img alt="" src="https://social.cybre.town/favicon.ico" className="inline-block rounded-lg w-10 h-10 cursor-pointer mr-2" id="icon_mastodon" onClick={() => window.open('https://byzer0.ml/mastodon')} /> 
